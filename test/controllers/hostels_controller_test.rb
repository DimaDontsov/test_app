...
class HostelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create hostel" do
    assert_difference('Hostel.count') do
      post hostels_url, params: { hostel: { about: @hostel.about, address: @hostel.address, city_id: @hostel.city_id, name: @hostel.name, price: @hostel.price } }
    end
  ...
  test "should update hostel" do
    patch hostel_url(@hostel), params: { hostel: { about: @hostel.about, address: @hostel.address, city_id: @hostel.city_id, name: @hostel.name, price: @hostel.price } }
